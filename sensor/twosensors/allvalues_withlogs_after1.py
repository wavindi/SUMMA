...
# ============================================================================
CALIBRATION_SAMPLES = 100       # More samples for stable baseline
MEDIAN_WINDOW = 3               # Fast spike rejection
MOVING_AVG_WINDOW = 2           # Quick response
OUTLIER_THRESHOLD = 50          # Allow return to baseline, block huge spikes
...
# Detection
DETECTION_THRESHOLD = 15        # Object if >15mm above baseline
MIN_ZONES_FOR_DETECTION = 3     # Need 3+ zones

# Zone configuration - USE ONLY GOOD ZONES
GOOD_ZONES = [0, 5, 9, 10, 11, 12, 13]  # Stable, low-noise zones
IGNORE_ZONES = [1, 2, 3, 4, 6, 7, 8, 14, 15]  # High noise/crosstalk
...
def main():
    ...
    filename = time.strftime("gen4_%Y_%m_%d_wa9t_%H_%M_%S.txt")
